import { E as EventsTarget, j as DOMEvent, V as ViewController, k as DeferredPromise, I as InferEventDetail, l as InferEventInit, S as State, m as Store, n as Scope, W as WriteSignal, R as ReadSignal, o as ReadSignalRecord, C as Context, D as Dispose, d as Component, p as StateContext } from './vidstack-b17407b1.js';
...
type MediaKeyShortcut = keyof MediaKeyShortcuts;
...
interface MediaStateAccessors extends Pick<MediaState, 'paused' | 'muted' | 'volume' | 'currentTime' | 'playsinline' | 'playbackRate'> {
}
...
declare class HTMLMediaProvider implements MediaProviderAdapter {
    ...
    play(): Promise<void>;
    pause(): Promise<void>;
    loadSource({ src, type }: MediaSrc$1, preload: any): Promise<void>;
}
...
declare class HLSProvider extends VideoProvider implements MediaProviderAdapter {
    ...
    preconnect(): void;
    setup(context: MediaSetupContext): void;
    loadSource({ src }: MediaSrc$1): Promise<void>;
    /**
 ...
 */
declare class Gesture extends Component<GestureProps> {
...
declare function useDefaultLayoutLang(translations: ReadSignal<DefaultLayoutTranslations | null>, word: keyof DefaultLayoutTranslations): string;
 ...
 */
interface MediaAutoplayFailEvent extends MediaEvent<{
    muted: boolean;
    error: Error;
}> {
}
 ...
 */
interface MediaAutoplayEvent extends MediaEvent<{
    muted: boolean;
}> {
}
/**
 ...
 * @detail progress
 */
interface MediaProgressEvent extends MediaEvent<{
    buffered: TimeRanges;
    seekable: TimeRanges;
}> {
}
 ...
 */
interface MediaTimeUpdateEvent extends MediaEvent<{
    currentTime: number;
    played: TimeRanges;
}> {
}
...
interface MediaPlayerEvents extends MediaEvents, MediaRequestEvents, MediaUserEvents, ScreenOrientationEvents, LoggerEvents, VideoPresentationEvents, HLSProviderEvents {
    'media-player-connect': MediaPlayerConnectEvent;
    'find-media-player': FindMediaPlayerEvent;
}
/**
...
export { MediaCanPlayThroughEvent as $, AudioProvider as A, ScreenOrientationType as B, ScreenOrientationLockType as C, mediaContext as D, MediaPlayerProps as E, FullscreenController as F, MediaStateAccessors as G, HLSProvider as H, MediaPlayerEvents as I, MediaRemoteControl as J, MediaControls as K, Logger as L, MediaProviderLoader as M, MediaEvents as N, MediaEvent as O, MediaAbortEvent as P, MediaAudioTracksChangeEvent as Q, MediaAudioTrackChangeEvent as R, SliderOrientation as S, Thumbnail as T, MediaAutoplayChangeEvent as U, VideoProvider as V, MediaAutoplayFailEvent as W, MediaAutoplayEvent as X, MediaCanLoadEvent as Y, MediaCanPlayEvent as Z, MediaCanPlayDetail as _, MediaSrc$1 as a, MediaPauseRequestEvent as a$, MediaControlsChangeEvent as a0, MediaRateChangeEvent as a1, MediaSourceChangeEvent as a2, MediaDestroyEvent as a3, MediaDurationChangeEvent as a4, MediaEmptiedEvent as a5, MediaEndEvent as a6, MediaEndedEvent as a7, MediaErrorEvent as a8, MediaFullscreenChangeEvent as a9, MediaStartedEvent as aA, MediaSuspendEvent as aB, MediaOrientationChangeEvent as aC, MediaReplayEvent as aD, MediaTimeUpdateEvent as aE, MediaStreamTypeChangeEvent as aF, MediaTextTracksChangeEvent as aG, MediaTextTrackChangeEvent as aH, MediaViewTypeChangeEvent as aI, MediaVolumeChange as aJ, MediaVolumeChangeEvent as aK, MediaWaitingEvent as aL, MediaRequestEvents as aM, MediaStartLoadingRequestEvent as aN, MediaTextTrackChangeRequestEvent as aO, MediaMuteRequestEvent as aP, MediaUnmuteRequestEvent as aQ, MediaFullscreenRequestTarget as aR, MediaAudioTrackChangeRequestEvent as aS, MediaEnterFullscreenRequestEvent as aT, MediaExitFullscreenRequestEvent as aU, MediaEnterPIPRequestEvent as aV, MediaExitPIPRequestEvent as aW, MediaLiveEdgeRequestEvent as aX, MediaPlayRequestEvent as aY, MediaQualityChangeRequestEvent as aZ, MediaRateChangeRequestEvent as a_, MediaFullscreenErrorEvent as aa, MediaLoadedDataEvent as ab, MediaLoadedMetadataEvent as ac, MediaLoopChangeEvent as ad, MediaLiveChangeEvent as ae, MediaLiveEdgeChangeEvent as af, MediaLoadStartEvent as ag, MediaTypeChangeEvent as ah, MediaPauseEvent as ai, MediaPlayEvent as aj, MediaPlayFailEvent as ak, MediaPlayingEvent as al, MediaPlaysinlineChangeEvent as am, MediaPosterChangeEvent as an, MediaProgressEvent as ao, MediaProviderLoaderChangeEvent as ap, MediaProviderChangeEvent as aq, MediaProviderSetupEvent as ar, MediaPIPChangeEvent as as, MediaPIPErrorEvent as at, MediaQualitiesChangeEvent as au, MediaQualityChangeEvent as av, MediaSeekedEvent as aw, MediaSeekingEvent as ax, MediaSourcesChangeEvent as ay, MediaStalledEvent as az, MediaType as b, AnyMediaProvider as b$, MediaSeekRequestEvent as b0, MediaSeekingRequestEvent as b1, MediaVolumeChangeRequestEvent as b2, MediaResumeControlsRequestEvent as b3, MediaPauseControlsRequestEvent as b4, MediaShowPosterRequestEvent as b5, MediaHidePosterRequestEvent as b6, MediaLoopRequestEvent as b7, MediaStreamType as b8, MediaViewType as b9, isTrackCaptionKind as bA, TextTrackListEvents as bB, TextTrackListEvent as bC, TextTrackAddEvent as bD, TextTrackRemoveEvent as bE, TextTrackListModeChangeEvent as bF, AudioTrackList as bG, AudioTrack as bH, AudioTrackListEvents as bI, AudioTrackListEvent as bJ, AudioTrackAddEvent as bK, AudioTrackRemoveEvent as bL, AudioTrackChangeEvent as bM, ChangeAudioTrackEventDetail as bN, PlayerQueryList as bO, PlayerQueryListEvents as bP, PlayerQueryListChangeEvent as bQ, VideoQualityList as bR, VideoQuality as bS, VideoQualityListEvents as bT, VideoQualityListEvent as bU, VideoQualityAddEvent as bV, VideoQualityRemoveEvent as bW, VideoQualityChangeEvent as bX, VideoQualityChangeEventDetail as bY, VideoQualityAutoChangeEvent as bZ, MediaKeyTarget as b_, MediaLoadingStrategy as ba, MediaErrorCode as bb, MediaErrorDetail as bc, MediaResource as bd, MediaPlayerState as be, mediaState as bf, softResetMediaState as bg, MediaStore as bh, PlayerStore as bi, MediaState as bj, MediaPlayerConnectEvent as bk, FindMediaPlayerEventDetail as bl, FindMediaPlayerEvent as bm, MediaUserEvents as bn, TextRenderers as bo, TextTrackReadyState as bp, TextTrackInit as bq, TextTrackEvents as br, TextTrackEvent as bs, TextTrackLoadStartEvent as bt, TextTrackLoadEvent as bu, TextTrackErrorEvent as bv, TextTrackAddCueEvent as bw, TextTrackRemoveCueEvent as bx, TextTrackCueChangeEvent as by, TextTrackModeChangeEvent as bz, MediaContext as c, HLSKeyLoadedEvent as c$, MediaProviderAdapter as c0, MediaSetupContext as c1, MediaFullscreenAdapter as c2, VideoPresentationEvents as c3, VideoPresentationChangeEvent as c4, HLSProviderEvents as c5, HLSMediaEvent as c6, HLSLibLoadStartEvent as c7, HLSLibLoadedEvent as c8, HLSLibLoadErrorEvent as c9, HLSAudioTrackSwitchedEvent as cA, HLSAudioTrackLoadingEvent as cB, HLSAudioTrackLoadedEvent as cC, HLSSubtitleTracksUpdatedEvent as cD, HLSSubtitleTracksClearedEvent as cE, HLSSubtitleTrackSwitchEvent as cF, HLSSubtitleTrackLoadingEvent as cG, HLSSubtitleTrackLoadedEvent as cH, HLSSubtitleFragProcessedEvent as cI, HLSCuesParsedEvent as cJ, HLSNonNativeTextTracksFoundEvent as cK, HLSInitPtsFoundEvent as cL, HLSFragLoadingEvent as cM, HLSFragLoadEmergencyAbortedEvent as cN, HLSFragLoadedEvent as cO, HLSFragDecryptedEvent as cP, HLSFragParsingInitSegmentEvent as cQ, HLSFragParsingUserdataEvent as cR, HLSFragParsingMetadataEvent as cS, HLSFragParsedEvent as cT, HLSFragBufferedDataEvent as cU, HLSFragChangedEvent as cV, HLSFpsDropEvent as cW, HLSFpsDropLevelCappingEvent as cX, HLSErrorEvent as cY, HLSDestroyingEvent as cZ, HLSKeyLoadingEvent as c_, HLSInstanceEvent as ca, HLSUnsupportedEvent as cb, HLSMediaAttachingEvent as cc, HLSMediaAttachedEvent as cd, HLSMediaDetachingEvent as ce, HLSMediaDetachedEvent as cf, HLSBufferResetEvent as cg, HLSBufferCodecsEvent as ch, HLSBufferCreatedEvent as ci, HLSBufferAppendingEvent as cj, HLSBufferAppendedEvent as ck, HLSBufferEosEvent as cl, HLSBufferFlushingEvent as cm, HLSBufferFlushedEvent as cn, HLSManifestLoadingEvent as co, HLSManifestLoadedEvent as cp, HLSManifestParsedEvent as cq, HLSLevelSwitchingEvent as cr, HLSLevelSwitchedEvent as cs, HLSLevelLoadingEvent as ct, HLSLevelLoadedEvent as cu, HLSLevelUpdatedEvent as cv, HLSLevelPtsUpdatedEvent as cw, HLSLevelsUpdatedEvent as cx, HLSAudioTracksUpdatedEvent as cy, HLSAudioTrackSwitchingEvent as cz, TextRenderer as d, SliderControllerProps as d$, HLSBackBufferReachedEvent as d0, HLSConstructor as d1, HLSConstructorLoader as d2, HLSLibrary as d3, HLSInstanceCallback as d4, DefaultLayout as d5, DefaultAudioLayout as d6, DefaultVideoLayout as d7, DefaultLayoutProps as d8, DefaultLayoutTranslations as d9, CaptionButtonProps as dA, CaptionButton as dB, FullscreenButtonProps as dC, FullscreenButton as dD, MuteButtonProps as dE, MuteButton as dF, PIPButtonProps as dG, PIPButton as dH, SeekButtonProps as dI, SeekButton as dJ, LiveButtonProps as dK, LiveButton as dL, SliderEvents as dM, SliderEvent as dN, SliderDragStartEvent as dO, SliderDragEndEvent as dP, SliderValueChangeEvent as dQ, SliderDragValueChangeEvent as dR, SliderPointerValueChangeEvent as dS, SliderCSSVars as dT, sliderState as dU, SliderStore as dV, SliderState as dW, Slider as dX, SliderProps as dY, SliderDelegate as dZ, SliderController as d_, DefaultLayoutContext as da, defaultLayoutContext as db, useDefaultLayoutLang as dc, useDefaultLayoutContext as dd, MediaPlayer as de, MediaProviderProps as df, MediaProviderState as dg, MediaProvider as dh, Controls as di, ControlsProps as dj, ControlsEvents as dk, ControlsChangeEvent as dl, ControlsGroup as dm, Tooltip as dn, TooltipProps as dp, TooltipTrigger as dq, TooltipContent as dr, TooltipPlacement as ds, TooltipPlacementSide as dt, TooltipPlacementAlign as du, TooltipContentProps as dv, ToggleButtonProps as dw, ToggleButton as dx, PlayButtonProps as dy, PlayButton as dz, TextTrack as e, SpeedRadioGroupProps as e$, SliderVideo as e0, SliderVideoProps as e1, SliderVideoState as e2, SliderVideoEvents as e3, SliderVideoCanPlayEvent as e4, SliderVideoErrorEvent as e5, SliderValue as e6, SliderValueProps as e7, SliderPreview as e8, updateSliderPreviewPlacement as e9, MenuItemsProps as eA, RadioGroup as eB, RadioGroupProps as eC, RadioGroupEvents as eD, RadioGroupChangeEvent as eE, Radio as eF, RadioProps as eG, RadioEvents as eH, RadioChangeEvent as eI, RadioSelectEvent as eJ, RadioOption as eK, ChaptersRadioGroup as eL, ChapterRadioGroupProps as eM, ChaptersRadioGroupEvents as eN, ChaptersRadioGroupChangeEvent as eO, ChaptersRadioOption as eP, AudioRadioGroup as eQ, AudioRadioGroupProps as eR, AudioRadioGroupEvents as eS, AudioRadioOption as eT, AudioRadioGroupChangeEvent as eU, CaptionsRadioGroup as eV, CaptionsRadioGroupProps as eW, CaptionsRadioGroupEvents as eX, CaptionsRadioOption as eY, CaptionsRadioGroupChangeEvent as eZ, SpeedRadioGroup as e_, SliderPreviewProps as ea, VolumeSliderProps as eb, VolumeSlider as ec, TimeSlider as ed, TimeSliderCSSVars as ee, TimeSliderProps as ef, SliderChapters as eg, SliderChaptersProps as eh, Menu as ei, MenuProps as ej, MenuEvents as ek, MenuOpenEvent as el, MenuCloseEvent as em, MenuButton as en, MenuButtonProps as eo, MenuButtonEvents as ep, MenuButtonSelectEvent as eq, MenuItem as er, MenuPortal as es, MenuPortalProps as et, MenuPortalContext as eu, menuPortalContext as ev, MenuItems as ew, MenuPlacement as ex, MenuPlacementSide as ey, MenuPlacementAlign as ez, TextTrackList as f, SpeedRadioGroupEvents as f0, SpeedRadioGroupChangeEvent as f1, QualityRadioGroup as f2, QualityRadioGroupProps as f3, QualityRadioOption as f4, QualityRadioGroupEvents as f5, QualityRadioGroupChangeEvent as f6, Gesture as f7, GestureProps as f8, GestureEventType as f9, GestureAction as fa, CaptionsProps as fb, Captions as fc, PosterProps as fd, PosterState as fe, Poster as ff, Time as fg, TimeProps as fh, TimeState as fi, ThumbnailState as fj, ThumbnailProps as fk, ThumbnailCoords as fl, ThumbnailsLoader as fm, MediaKeyShortcuts as g, MediaKeyShortcut as h, ListItem as i, List as j, ListEvents as k, ListAddEvent as l, ListRemoveEvent as m, ListReadonlyChangeEvent as n, canFullscreen as o, FullscreenAdapter as p, FullscreenEvents as q, FullscreenChangeEvent as r, FullscreenErrorEvent as s, LoggerEvents as t, LogEventDetail as u, LogEvent as v, ScreenOrientationController as w, ScreenOrientationEvents as x, ScreenOrientationChangeEventDetail as y, ScreenOrientationChangeEvent as z };
